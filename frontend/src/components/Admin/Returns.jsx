                  ...
                  <div className="space-y-2 min-w-[320px]">
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        onClick={async () => {
                          try {
                            setUpdatingId(r._id);
                            await client.patch(`/returns/${r._id}/status`, {
                            ...
                            const res = await client.get("/returns/admin/all", {
                              limit: 20,
                            });
                            if (res?.success) setItems(res.data.returns);
                          } catch (e) {
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      ...
                      <input
                        ...
                        onChange={(e) =>
                          setPickupForm({ ...pickupForm, city: e.target.value })
                        }
                      />
                      <input
                        className="border rounded px-2 py-1"
                      ...
                      <input
                        ...
                        value={pickupForm.trackingNumber}
                        onChange={(e) =>
                          setPickupForm({
                            ...pickupForm,
                      ...
                      <button
                        ...
                        onClick={async () => {
                          try {
                            ...
                            await client.patch(`/returns/${r._id}/pickup`, {
                              address,
                              scheduledDate: pickupForm.scheduledDate,
                              carrier: pickupForm.carrier,
                              trackingNumber: pickupForm.trackingNumber,
                            });
                            const res = await client.get("/returns/admin/all", {
                              limit: 20,
                            });

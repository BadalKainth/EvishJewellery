...
export const CartContext = createContext({
  cart: { items: [], totals: { subtotal: 0, discount: 0, total: 0, totalItems: 0 }, itemCount: 0 },
  loading: false,
  refreshCart: async () => {},
  addItem: async () => {},
  updateItem: async () => {},
...
export const CartProvider = ({ children }) => {
  ...
  const value = useMemo(() => ({
    cart: cart || { items: [], totals: { subtotal: 0, discount: 0, total: 0, totalItems: 0 }, itemCount: 0 },
    loading,
    refreshCart,
    addItem,
    updateItem,
    ...
    applyCoupon,
    removeCoupon,
  }), [cart, loading, refreshCart, addItem, updateItem, removeItem, clear, applyCoupon, removeCoupon]);
